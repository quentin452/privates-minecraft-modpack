...
@quest_line PlumePack_Vietnam Quest Line
@status incomplete
...
>quest PlumePack_Vietnam_intro
    ...
    requires: PlumePack_Vietnam Quest Line:PlumePack_Vietnam_discover
    logic: AND
...
>quest PlumePack_Vietnam_master
    ...
    requires: PlumePack_Vietnam Quest Line:PlumePack_Vietnam_intro
    logic: AND
