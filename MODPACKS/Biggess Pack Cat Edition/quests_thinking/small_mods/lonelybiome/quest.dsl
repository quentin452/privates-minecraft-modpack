...
>quest lonelybiome_discover
    title: Discover lonelybiome
    desc: Find and identify items or blocks from lonelybiome
    requires: none
    logic: AND
    task: checkbox "Explore and find items from lonelybiome"
    reward: xp 50
    repeatable: no
    auto_claim: no
