...
>quest geoactivity_discover
    title: Discover geoactivity
    desc: Find and identify items or blocks from geoactivity
    requires: none
    logic: AND
    task: checkbox "Explore and find items from geoactivity"
    reward: xp 50
    repeatable: no
    auto_claim: no
