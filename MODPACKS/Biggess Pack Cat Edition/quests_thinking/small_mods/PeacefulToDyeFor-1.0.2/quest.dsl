...
>quest peacefultodyefor_1_0_2_discover
    title: Discover PeacefulToDyeFor-1.0.2
    desc: Find and identify items or blocks from PeacefulToDyeFor-1.0.2
    requires: none
    logic: AND
    task: checkbox "Explore and find items from PeacefulToDyeFor-1.0.2"
    reward: xp 50
    repeatable: no
    auto_claim: no
