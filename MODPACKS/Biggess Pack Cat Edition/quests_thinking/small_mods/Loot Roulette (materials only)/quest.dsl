...
@size 0.02MB
@category small_mods
@quest_line Loot Roulette (materials only) Quest Line
@status incomplete
...
>quest loot_roulette_materials_only_intro
    ...
    requires: Loot Roulette (materials only) Quest Line:loot_roulette_materials_only_discover
    logic: AND
...
>quest loot_roulette_materials_only_master
    ...
    requires: Loot Roulette (materials only) Quest Line:loot_roulette_materials_only_intro
    logic: AND
