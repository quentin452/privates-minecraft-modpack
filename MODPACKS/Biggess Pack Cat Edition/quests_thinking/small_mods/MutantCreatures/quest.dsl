...
@size 1.04MB
@category small_mods
@quest_line MutantCreatures Quest Line
@status incomplete
...
>quest mutantcreatures_intro
    ...
    requires: MutantCreatures Quest Line:mutantcreatures_discover
    logic: AND
...
>quest mutantcreatures_master
    ...
    requires: MutantCreatures Quest Line:mutantcreatures_intro
    logic: AND
