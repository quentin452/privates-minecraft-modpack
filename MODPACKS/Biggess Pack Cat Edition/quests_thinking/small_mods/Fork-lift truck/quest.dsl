...
@size 0.04MB
@category small_mods
@quest_line Fork-lift truck Quest Line
@status incomplete
...
>quest fork_lift_truck_intro
    ...
    requires: Fork-lift truck Quest Line:fork_lift_truck_discover
    logic: AND
...
>quest fork_lift_truck_master
    ...
    requires: Fork-lift truck Quest Line:fork_lift_truck_intro
    logic: AND
