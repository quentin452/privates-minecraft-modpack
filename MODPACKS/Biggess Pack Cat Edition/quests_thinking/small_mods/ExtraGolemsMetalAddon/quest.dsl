...
@size 0.39MB
@category small_mods
@quest_line ExtraGolemsMetalAddon Quest Line
@status incomplete
...
>quest extragolemsmetaladdon_intro
    ...
    requires: ExtraGolemsMetalAddon Quest Line:extragolemsmetaladdon_discover
    logic: AND
...
>quest extragolemsmetaladdon_master
    ...
    requires: ExtraGolemsMetalAddon Quest Line:extragolemsmetaladdon_intro
    logic: AND
