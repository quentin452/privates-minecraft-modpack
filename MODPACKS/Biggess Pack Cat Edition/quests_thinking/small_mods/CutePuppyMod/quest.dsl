...
>quest cutepuppymod_discover
    title: Discover CutePuppyMod
    desc: Find and identify items or blocks from CutePuppyMod
    requires: none
    logic: AND
    task: checkbox "Explore and find items from CutePuppyMod"
    reward: xp 50
    repeatable: no
    auto_claim: no
