...
@size 0.04MB
@category small_mods
@quest_line CobblestoneCraftingTable Quest Line
@status incomplete
...
>quest cobblestonecraftingtable_intro
    ...
    requires: CobblestoneCraftingTable Quest Line:cobblestonecraftingtable_discover
    logic: AND
...
>quest cobblestonecraftingtable_master
    ...
    requires: CobblestoneCraftingTable Quest Line:cobblestonecraftingtable_intro
    logic: AND
