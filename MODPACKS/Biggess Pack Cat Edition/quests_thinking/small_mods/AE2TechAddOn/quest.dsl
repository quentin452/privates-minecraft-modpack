...
>quest ae2techaddon_discover
    title: Discover AE2TechAddOn
    desc: Find and identify items or blocks from AE2TechAddOn
    requires: none
    logic: AND
    task: checkbox "Explore and find items from AE2TechAddOn"
    reward: xp 50
    repeatable: no
    auto_claim: no
