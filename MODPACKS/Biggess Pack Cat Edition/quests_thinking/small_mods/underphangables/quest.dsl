...
@size 0.01MB
@category small_mods
@quest_line underphangables Quest Line
@status incomplete
...
>quest underphangables_intro
    ...
    requires: underphangables Quest Line:underphangables_discover
    logic: AND
...
>quest underphangables_master
    ...
    requires: underphangables Quest Line:underphangables_intro
    logic: AND
