...
@size 0.01MB
@category small_mods
@quest_line Timely Stones Mod Quest Line
@status incomplete
...
>quest timely_stones_mod_intro
    ...
    requires: Timely Stones Mod Quest Line:timely_stones_mod_discover
    logic: AND
...
>quest timely_stones_mod_master
    ...
    requires: Timely Stones Mod Quest Line:timely_stones_mod_intro
    logic: AND
