...
@size 0.09MB
@category small_mods
@quest_line castleblocks-1.0 Quest Line
@status incomplete
...
>quest castleblocks_1_0_intro
    ...
    requires: castleblocks-1.0 Quest Line:castleblocks_1_0_discover
    logic: AND
...
>quest castleblocks_1_0_master
    ...
    requires: castleblocks-1.0 Quest Line:castleblocks_1_0_intro
    logic: AND
