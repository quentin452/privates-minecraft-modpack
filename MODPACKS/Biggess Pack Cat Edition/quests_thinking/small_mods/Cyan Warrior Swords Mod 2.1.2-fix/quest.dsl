...
@size 0.29MB
@category small_mods
@quest_line Cyan Warrior Swords Mod 2.1.2-fix Quest Line
@status incomplete
...
>quest cyan_warrior_swords_mod_2_1_2_fix_intro
    ...
    requires: Cyan Warrior Swords Mod 2.1.2-fix Quest Line:cyan_warrior_swords_mod_2_1_2_fix_discover
    logic: AND
...
>quest cyan_warrior_swords_mod_2_1_2_fix_master
    ...
    requires: Cyan Warrior Swords Mod 2.1.2-fix Quest Line:cyan_warrior_swords_mod_2_1_2_fix_intro
    logic: AND
