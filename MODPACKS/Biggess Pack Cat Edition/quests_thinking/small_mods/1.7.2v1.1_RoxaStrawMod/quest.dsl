...
@size 0.01MB
@category small_mods
@quest_line 1.7.2v1.1_RoxaStrawMod Quest Line
@status incomplete
...
>quest 1_7_2v1_1_roxastrawmod_intro
    ...
    requires: 1.7.2v1.1_RoxaStrawMod Quest Line:1_7_2v1_1_roxastrawmod_discover
    logic: AND
...
>quest 1_7_2v1_1_roxastrawmod_master
    ...
    requires: 1.7.2v1.1_RoxaStrawMod Quest Line:1_7_2v1_1_roxastrawmod_intro
    logic: AND
