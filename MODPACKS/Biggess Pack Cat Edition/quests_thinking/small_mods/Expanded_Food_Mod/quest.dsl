...
>quest expanded_food_mod_discover
    title: Discover Expanded_Food_Mod
    desc: Find and identify items or blocks from Expanded_Food_Mod
    requires: none
    logic: AND
    task: checkbox "Explore and find items from Expanded_Food_Mod"
    reward: xp 50
    repeatable: no
    auto_claim: no
