...
@size 1.25MB
@category small_mods
@quest_line ToolUpgrades 1.7.10 (v.1.2.3)QL
@status incomplete
...
>quest toolupgrades_1_7_10_v_1_2_3_intro
    ...
    requires: ToolUpgrades 1.7.10 (v.1.2.3)QL:toolupgrades_1_7_10_v_1_2_3_discover
    logic: AND
...
>quest toolupgrades_1_7_10_v_1_2_3_master
    ...
    requires: ToolUpgrades 1.7.10 (v.1.2.3)QL:toolupgrades_1_7_10_v_1_2_3_intro
    logic: AND
