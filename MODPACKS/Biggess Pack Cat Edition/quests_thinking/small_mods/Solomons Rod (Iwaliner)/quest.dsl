...
@size 0.04MB
@category small_mods
@quest_line Solomons Rod (Iwaliner)QL
@status incomplete
...
>quest solomons_rod_iwaliner_intro
    ...
    requires: Solomons Rod (Iwaliner)QL:solomons_rod_iwaliner_discover
    logic: AND
...
>quest solomons_rod_iwaliner_master
    ...
    requires: Solomons Rod (Iwaliner)QL:solomons_rod_iwaliner_intro
    logic: AND
