...
@size 0.08MB
@category small_mods
@quest_line Waystones_Jawsawn_ForkQL
@status incomplete
...
>quest waystones_jawsawn_fork_intro
    ...
    requires: Waystones_Jawsawn_ForkQL:waystones_jawsawn_fork_discover
    logic: AND
...
>quest waystones_jawsawn_fork_master
    ...
    requires: Waystones_Jawsawn_ForkQL:waystones_jawsawn_fork_intro
    logic: AND
