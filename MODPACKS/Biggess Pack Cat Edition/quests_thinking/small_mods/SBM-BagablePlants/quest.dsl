...
@size 0.02MB
@category small_mods
@quest_line SBM-BagablePlants Quest Line
@status incomplete
...
>quest sbm_bagableplants_intro
    ...
    requires: SBM-BagablePlants Quest Line:sbm_bagableplants_discover
    logic: AND
...
>quest sbm_bagableplants_master
    ...
    requires: SBM-BagablePlants Quest Line:sbm_bagableplants_intro
    logic: AND
