...
@size 0.76MB
@category small_mods
@quest_line MukaStructureMod_1.0.2 Quest Line
@status incomplete
...
>quest mukastructuremod_1_0_2_intro
    ...
    requires: MukaStructureMod_1.0.2 Quest Line:mukastructuremod_1_0_2_discover
    logic: AND
...
>quest mukastructuremod_1_0_2_master
    ...
    requires: MukaStructureMod_1.0.2 Quest Line:mukastructuremod_1_0_2_intro
    logic: AND
