...
@size 0.15MB
@category small_mods
@quest_line MagnificentTrinkets Beta 0.1bQL
@status incomplete
...
>quest magnificenttrinkets_beta_0_1b_intro
    ...
    requires: MagnificentTrinkets Beta 0.1bQL:magnificenttrinkets_beta_0_1b_discover
    logic: AND
...
>quest magnificenttrinkets_beta_0_1b_master
    ...
    requires: MagnificentTrinkets Beta 0.1bQL:magnificenttrinkets_beta_0_1b_intro
    logic: AND
