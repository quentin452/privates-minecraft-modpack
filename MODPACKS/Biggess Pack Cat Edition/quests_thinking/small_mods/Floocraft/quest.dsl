...
>quest floocraft_discover
    title: Discover Floocraft
    desc: Find and identify items or blocks from Floocraft
    requires: none
    logic: AND
    task: checkbox "Explore and find items from Floocraft"
    reward: xp 50
    repeatable: no
    auto_claim: no
