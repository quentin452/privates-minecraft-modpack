...
>quest additionalresources_1_7_10_discover
    title: Discover additionalresources-1.7.10
    desc: Find and identify items or blocks from additionalresources-1.7.10
    requires: none
    logic: AND
    task: checkbox "Explore and find items from additionalresources-1.7.10"
    reward: xp 50
    repeatable: no
    auto_claim: no
