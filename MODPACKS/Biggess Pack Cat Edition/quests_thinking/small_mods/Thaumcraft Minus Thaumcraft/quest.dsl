...
>quest thaumcraft_minus_thaumcraft_discover
    title: Discover Thaumcraft Minus Thaumcraft
    desc: Find and identify items or blocks from Thaumcraft Minus Thaumcraft
    requires: none
    logic: AND
    task: checkbox "Explore and find items from Thaumcraft Minus Thaumcraft"
    reward: xp 50
    repeatable: no
    auto_claim: no
