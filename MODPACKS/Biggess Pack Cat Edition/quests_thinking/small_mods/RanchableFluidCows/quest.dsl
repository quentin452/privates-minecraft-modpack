...
>quest ranchablefluidcows_discover
    title: Discover RanchableFluidCows
    desc: Find and identify items or blocks from RanchableFluidCows
    requires: none
    logic: AND
    task: checkbox "Explore and find items from RanchableFluidCows"
    reward: xp 50
    repeatable: no
    auto_claim: no
