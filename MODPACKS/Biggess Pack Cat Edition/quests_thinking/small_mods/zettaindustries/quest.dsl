...
@size 1.49MB
@category small_mods
@quest_line zettaindustries Quest Line
@status incomplete
...
>quest zettaindustries_intro
    ...
    requires: zettaindustries Quest Line:zettaindustries_discover
    logic: AND
...
>quest zettaindustries_master
    ...
    requires: zettaindustries Quest Line:zettaindustries_intro
    logic: AND
