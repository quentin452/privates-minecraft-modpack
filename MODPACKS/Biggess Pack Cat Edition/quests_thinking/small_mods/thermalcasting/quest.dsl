...
>quest thermalcasting_discover
    title: Discover thermalcasting
    desc: Find and identify items or blocks from thermalcasting
    requires: none
    logic: AND
    task: checkbox "Explore and find items from thermalcasting"
    reward: xp 50
    repeatable: no
    auto_claim: no
