...
@size 0.08MB
@category small_mods
@quest_line RitualEnchanting Quest Line
@status incomplete
...
>quest ritualenchanting_intro
    ...
    requires: RitualEnchanting Quest Line:ritualenchanting_discover
    logic: AND
...
>quest ritualenchanting_master
    ...
    requires: RitualEnchanting Quest Line:ritualenchanting_intro
    logic: AND
