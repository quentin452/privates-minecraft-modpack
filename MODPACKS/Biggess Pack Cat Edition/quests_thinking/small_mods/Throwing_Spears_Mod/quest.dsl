...
@size 0.16MB
@category small_mods
@quest_line Throwing_Spears_Mod Quest Line
@status incomplete
...
>quest throwing_spears_mod_intro
    ...
    requires: Throwing_Spears_Mod Quest Line:throwing_spears_mod_discover
    logic: AND
...
>quest throwing_spears_mod_master
    ...
    requires: Throwing_Spears_Mod Quest Line:throwing_spears_mod_intro
    logic: AND
