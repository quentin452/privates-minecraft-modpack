...
@size 0.04MB
@category small_mods
@quest_line Storage_Silo_Mod Quest Line
@status incomplete
...
>quest storage_silo_mod_intro
    ...
    requires: Storage_Silo_Mod Quest Line:storage_silo_mod_discover
    logic: AND
...
>quest storage_silo_mod_master
    ...
    requires: Storage_Silo_Mod Quest Line:storage_silo_mod_intro
    logic: AND
