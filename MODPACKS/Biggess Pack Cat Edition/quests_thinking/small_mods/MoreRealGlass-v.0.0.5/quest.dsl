...
@size 0.02MB
@category small_mods
@quest_line MoreRealGlass-v.0.0.5 Quest Line
@status incomplete
...
>quest morerealglass_v_0_0_5_intro
    ...
    requires: MoreRealGlass-v.0.0.5 Quest Line:morerealglass_v_0_0_5_discover
    logic: AND
...
>quest morerealglass_v_0_0_5_master
    ...
    requires: MoreRealGlass-v.0.0.5 Quest Line:morerealglass_v_0_0_5_intro
    logic: AND
