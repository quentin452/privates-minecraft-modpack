...
* mod_voxelMap_1.7.0b_for_1.7.10

**mods deleted**

* journeymap-1.7.10-5.1.4p2-unlimited
* JourneyMapQol_1.7.10-0.8.9
...
* ssmlegacy-mc1.7.10-1.2.0
* hodgepodge-1.7.10-2.0.16
...
* ae2fc-1.7.10-1.0.46-gtnh to 1.0.47-gtnh-pre
* CoreTweaks-1.7.10-0.3-8-g3ede53b to 0.3.0.1
...
* B:STARTUP_OPTIMIZATIONS=true to false

**fixe**

* fix [#66](https://github.com/quentin452/privates-minecraft-modpack/issues/66)
...
* archaicfix-mc1.7.10-v0.4.0 to v0.4.0-1-g00c17ab
