...
-XX:+UseConcMarkSweepGC -XX:+UnlockExperimentalVMOptions -XX:MaxGCPauseMillis=50 -XX:GCTimeRatio=15M -XX:+AlwaysPreTouch -XX:+DisableExplicitGC -XX:+UseTLAB -XX:-UseBiasedLocking -XX:+OptimizeStringConcat -Xnoclassgc -XX:-UseLargePages
...
⚠️ You should remove all of your mods in your mods folder (just keep !mod-director-launchwrapper-1.8.0-all) when you update the modpack⚠️
...
* fix some GC crashes by switching between serializationsisbad and Pipe blocker 
