...
# `I RECOMMAND HAVING MORE THAN 20 GB OF RAM INSTALLED ON YOUR SYSTEM TO AVOID OUT OF MEMORY CRASH ON GAME STARTUP`
...
⚠️ If you have opengl errors try disabling fastcraft ⚠️

⚠️ If you have chunk flashing issues or you are on Intel graphics card try disabling UseMultiDrawIndirect from beddium ⚠️
...
* OptimizationsAndTweaks V1.17.6 → V1.17.7 — fixes a crash when leaving a world (CodeChickenLib chunk-unload null-guard).

**mods deleted**

* Mimicry — removed: it spawned a hostile mob that instantly died for no reason (spawn/death loop).

**config updated**

* Muya — disabled the target-information HUD overlay, which crashed the client when aiming at mobs without mana (the player health/mana bar stays on).
...
* OptimizationsAndTweaks V1.17.4 -> V1.17.6:
  - Broad mixin conversions for better compatibility with other mods (fewer conflicts)
  - Worldgen cascade fixes for ManaMetalMod (fewer far-chunk generation stalls)
  - Fixed a CoFH-related startup crash
  - Windows natives rebuilt (static CRT)
* BiomesOPlenty 2.1.0.2309 -> 2.1.0.2310:
  - Deterministic worldgen + guard against malformed generator weights (fixes a worldgen crash)
* lwjgl3ify 2.1.15 -> 3.0.26:
  - Major upgrade to the input backend (GLFW to SDL): mouse/keyboard and modern-Java improvements
* ADFix -> without-mysteriumlib fork (drops the mysteriumlib dependency)

V1.1.10

**mods updated**

* OptimizationsAndTweaks V1.17.3 -> V1.17.4: Mekanism post-init recipe generation ~3x faster, BiomesOPlenty decoration speedups, collision @Overwrite cleanup (restores ArchaicFix's collision-margin fix), ManaMetal missing-schematic log spam eliminated.

V1.1.9

**config updated**

* Reduced CoFH ore-generation density (copper ~1/3 of before with the redundant second copper pass removed, tin ~2/3) to cut worldgen lag. Copper and tin remain common.

V1.1.8

**mods updated**

* OptimizationsAndTweaks -> V1.17.3
* BetterQuesting -> 3.8.9-CAT
* LootBeamsBackport -> 1.0.4 (client-side)
* Essence of the Gods (eotg) -> V1.5.6
* ImmersiveEngineering -> 0.7.11-fork4 (world open ~3x faster: oredict lookup memoized)
...
* fix survival HUD crash on the health bar (uncancelable event) by updating oat + eotg
* fix mobs not fleeing/panicking at the correct speed when hit by updating oat
* fix boot crash from duplicate enchantment ids by updating oat

V1.1.7

**mods updated**

* LOTRModfork.v36.33 to v36.35
* optimizationsandtweaks-V1.17.0 to V1.17.1

**fixe**

* fix 3 NPEs by updating lotr and oat
* fix thaumcraft tilenode npe by updating oat
* fix arrayIndexOutOfBoundsException caused by xaero by updating oat
* fix some crashes by updating oat and lotr
...
* optimizationtaandtweaks-V1.16.7 to 1.17.0
* falsetweaks-mc1.7.10-4.1.1fork1 to 4.1.1fork2
* ImmersiveEngineering-mc1.7.10-0.7.11-fork2 to 0.7.11-fork3
...
-endlessids.cfg
* set "extraBlockIDBits" to 4
* set "extraItemIDBits" to 1

-manametalmod.cfg
* set "MedalTitle" to false

-coretweaks.cfg
* set "fc_optimize_texture_upload" to false
* set "transformer_cache" to true

**fixe**

* fix ids conflicts with manametal by updating witching gadgets and fossilarcheology confs
* fix manametal already tessellating crash by updating falsetweaks
* fix buildcraft oil tweak crash by updating optimizationsandtweaks
* fix mofifiableattributeinstance crash by updating optimizationsandtweaks
* fix chunk bug with manametal by disabling fc_optimize_texture_upload from coretwekas

**other**

* optimize eventfog from manametal by updating optimizationsandtweaks
* optimize nbttagcompound by updating optimizationsandtweaks
* optimize particlerenderer from immersiveengineering
* removed MicroHUD due to manametal hud placements
* moved wdmla hud position due to manametal hud placements
...
* optimizationtaandtweaks-V1.16.4 to 1.16.7
...
* disabled grave from openblocks since we had an another mod that add graves
* significantly reduced path finding lags by updating optimizationsandtweaks and by using its rust async rewrite

---------------------------------------------------------------------------

**NOTE**

* for serverpack you should remove beddium from your server/mods folder if exist

V1.1.4REMOVE_BEDDIUM_FROM_SERVER

**mods added**

* Salutation-1.7.10-1.0.0
* CarbonConfig-1.7.10-1.1.5

**mods updated**

* optimizationtaandtweaks-V1.15.9 to 1.16.4
* archaicfix-0.7.0fork9 to 0.7.0fork10

**fixe**

* fix dungeon mob url
* fix salutation is causing StackOverflow on server
* fix beddium crash on server by mading it client side 
...
* fix "Failed to spawn entity: DMRustMonster" by updating dungeon mobs
...
* BetterQuesting-3.7.14-GTNH to 3.8.8-CAT
* CoFHCore-[1.7.10]3.1.4-329 to 3.1.5-revived  
* lumi-mc1.7.10-1.2.0 to 1.2.0fork1 
* falsetweaks-mc1.7.10-4.1.1 to 4.1.1fork1                                                
      
**mods deleted**

* MatoiVanillaPack1.5.2_on_1.7.10
* SimpleArmorFly

**config updated**

-beddium.cfg
* set "ConservativeAnimatedTextures" to true

**fixe**

* fix getChunkRootFromChunkPosIfExists from LUMI causing massive lags 
* reduce fps overhead caused by animfix module from falsetweaks

**other**

* removed MatoiVanillaPack because it requires real train mod
* starting making quests on betterquesting using scripting
...
* beddium-mc1.7.10-1.0.1-j21 to 1.0.4-j21
* MoCreatures-Legacy-Final-1.1 to 1.2
* gtnhlib-0.6.39 to 0.7.0
* hodgepodge-2.6.107 to 2.7.2
* falsetweaks-mc1.7.10-4.0.5 to 4.1.1
* endlessids-mc1.7.10-1.6.12 to 1.6.13
* NotEnoughItems-2.7.90-GTNH to 2.8.7-GTNH-pre
* Mekanism-Community-Edition-1.7.10-9.10.45-Core to 9.10.46
* Mekanism-Community-Edition-1.7.10-9.10.45-Generators to 9.10.46
* D3Core-1.7.10-1.1.3 to 1.1.4

-------------------------------------------------------------------------

V1.1.0INCREMENTAL_DOWNLOAD_UPDATE

**IMPORTANT**

* No more manual mods removals every time you update! Mod Director now automatically manages file additions and removals based on actual needs.

* You just need to remove the old version of mod director in mods folder if exist before launching the modpack

**mods updated**

* wizardry-1.7.10-1.1.6fork6 to fork7
* !mod-director-launchwrapper-1.9.1 to 1.9.1fork6
* falsepatternlib-mc1.7.10-1.9.0 to 1.9.1
* optimizationsandtweaks-V1.15.8 to V1.15.9
...
* set "Enable Overlay" to false for "status"

**fixe**

* fix tracePath performances from wizardry
* fix double effect status icon rendering by disabling the overlay of status from adventurebackpack
* fix "unknownametag name appearing after killing mobs if shatter mod is installed by updating catculling
...
* optimizationsandtweaks-V1.15.4 to V1.15.8
* alternatecurrent-1.5.1 to 1.5.1fork1
* mariculture-1.3.0-6fork6 to fork7
...
* fix eternal frost 2 mob spawners + class cast exception by updating optimizationsandtweaks
* fix massive fps lags caused by isInRangeToRender3d by updating optimizationsandtweaks
* fix massive fps lags caused by TextureUtil.func_152777_a calls from ItemRenderer by updating optimizationsandtweaks
* fix NPE crash caused by alternatecurrent during worldgeneration of structures
* fix massive fps lags caused by hat rendering from mariculture by updating it
...
* +Mycelium-2.3
* alternatecurrent-1.5.1
* noleafdecay-1.0fork1
* MicroHUD-1.7.10

**mods deleted**

* IamacatHUDV0.9-mc1.7.10-forge

**config updated**

-optimizationsandtweaks.cfg
* set "enableMixinPatchBlockMagicalLeavesPerformances" to false
* set "enableMixinBlockLeaves" to false
...
* fix key events issues from IamacatHUD
* fix massive lags caused by leaves in big forest by adding noleafdecay and so disabling mixins that affect leaves from optimizationsandtweaks since they are not needed while using noleafdecay

**other**

* removed IamacatHUD because now we use microhud
...
* marchofents-1.3
* FoodCraft-1.7.10-v1.0
* BiomesOPlenty-1.7.10-2.1.0.2309-universal
* doorsoplenty-1.0
* GalaxySpace-1.7.10-1.2.15

**mods updated**

* optimizationsandtweaks-v1.15.2 to v1.15.4
* RecurrentComplex-0.9.7.1.8 to 0.9.7.1.9
* IvToolkit-1.2.2 to 1.2.3

**mods downgraded**

* fastcraft-1.25 to 1.23

**mods deleted**

* alternativechunkloading-1.4.4

**config updated**

-biomesoplenty
 -terraingen.cfg
 * set "Add Biomes To Default World" to true

-endlessids.cfg
* set "extendDataWatcher" to true

-optimizationsandtweaks.cfg
* set "enableMixinDataWatcher" to false
* set "enableMixinTextureManager" to false
* set "enableMixinGodZillaFix" to true

**fixe**

* fix [#45](https://github.com/quentin452/privates-minecraft-modpack/issues/45)
* fix a big bottleneck caused by recurrentcomplex 
* fix random NPE at world loading caused by Atum by updating optimizationsandtweaks
* fix compat with endlessids by disabling mixindatawatcher from optimizationsandtweaks
* fix a crash with llibrary by disabling mixintexturemanager from optimizationsandtweaks
* fix cannot launch the serverpack by updating optimizationsandtweaks
* fix cannot hotload dimension crashes by removing alternativechunkloading
...
* deleted super ores because too much OP
...
* fix some bugs caused by Gravestone mod by swaping gravestone mod
...
* optimizationsandtweaks-v1.15.1 to V1.15.2

**mods deleted**

* minestones-1.7.10-MS1.0.2

**fixe**

* fix ConcurrentModificationException at saves loading by updating optimizationsandtweaks
...
* optimizationsandtweaks-v1.14.8 to V1.15.1
* NotEnoughItems-2.7.88-GTNH to 2.7.90
* endlessids-mc1.7.10-1.6.11 to 1.6.12
* falsetweaks-mc1.7.10-4.0.2 to 4.0.5
* hodgepodge-2.6.106 to 2.6.107

**config updated**

-minestones.cfg
* set stoneDropRate to 100

-ImmersiveEngineering.cfg
* set copper vein to 0

-SpiritOresMod.cfg
* set Enable COPPER Ore to false

**fixe**

* fix a big mistake that caused the modpack to download wrong mods (caused by V1.0.2)
...
* optimizationsandtweaks-V1.14.8 to V1.15.0
...
-Galacticraft
 -core.cfg
 * set "Enable Copper Ore Gen" to false

**fixe**

* fix mob overlay is doesn't work in cave by using Light Level Overlay reloaded instead of Nei moboverlay
* fix wolf nametag from doggytalent not get rendered by updating optimizationsandtweaks
...
* optimizationsandtweaks-V1.14.7 to V1.14.8

**fixe**

* fix [#943](https://github.com/quentin452/privates-minecraft-modpack/issues/943) 
* fix [#944](https://github.com/quentin452/privates-minecraft-modpack/issues/944) 

---------------------------------------------------------------------------

V1.0 ⚠️ THIS VERSION MIGHT BE INCOMPATIBLE OR COULD CAUSE CORRUPTIONS WITH OLD SAVES ⚠️

**GET RID OF CONFIGHELPER**
**ADDED LWJGl3IFY/FASTCRAFT SUPPORT**

**mods added**

* ae2fc-1.4.114-gtnh
* OreSpawnLegacy(1.7.10)
* lwjgl3ify-2.1.15fork1
* lwjgl3ify-2.1.15-forgePatches
* ae2noultimatepatterns-1.0.1
* structurecompat-0.7.4
* logisticspipes-1.4.23-GTNH-pre
* modernmarkings-0.3.12-1.7.10
* beddium-mc1.7.10-1.0.1-j21
* catculling-V1.0.0
* hudcaching-V1.0.0
* redirectionor-1.9 for 1.7.10
* modularui2-2.2.18-1.7.10
* CraftPresence-2.6.2+1.7.10-forge
* alternativechunkloading-1.4.4
* postea-1.1.3
* fastcraft-1.25
* lumi-mc1.7.10-1.2.0
* bogosorter-1.2.60-GTNH

**mods updated**

* optimizationsandtweaks-V1.14.4 to V1.14.7
* LOTRModfork.v36.29 to v36.33
* IamacatHUDV0.7 to V0.9
* BiggessPackTweak-V1.1 to V1.2.1
* NotEnoughItems-2.6.47-GTNH to 2.7.88-GTNH 
* SimpleLabels-1.7.10-1.0-9 to 1.0-9fork1 
* CodeChickenCore-1.3.10 to 1.4.7 
* gtnhlib-0.5.20 to 0.6.39
* TwilightForest-2.6.35 to 2.7.13
* Wawla-1.2.0-GTNH to 1.3.1-GTNH 
* Waila-1.8.1 to 1.8.14
* appliedenergistics2-rv3-beta-474-GTNH to rv3-beta-688-GTNH
* NotEnoughEnergistics-1.6.4 to 1.7.14
* backpack-2.4.3-GTNH to 2.5.9
* hodgepodge-2.5.77.fork1 to 2.6.106
* battlegear2-1.4.1 to 1.4.3
* TConstruct-1.12.13-GTNH to 1.13.54
* NEIAddons-1.15.0 to 1.17
* Draconic-Evolution-1.3.13-GTNH to 1.4.27
* BaublesExpanded-2.1.4 to 2.1.15
* BloodMagic-1.6.7 to 1.7.51
* structurelib-1.3.5 to 1.4.23
* chisel-2.15.3-GTNH to 2.16.13
* ArchitectureCraft-1.10.1 to 1.11.5
* thaumicenergistics-1.6.27-GTNH to 1.7.14
* adventurebackpack-1.2.3-GTNH to 1.3.1
* littletiles-1.3.1-GTNH to 1.5.14
* ThaumcraftMobAspects-1.1.2-GTNH to 1.2.1
* BetterQuesting-3.6.22-GTNH to 3.7.14
* Natura-2.7.5 to 2.8.9
* Botania-1.11.5-GTNH to 1.12.25
* OpenComputers-1.10.27-GTNH to 1.11.19
* Avaritia-1.54 to 1.75
* WitchingGadgets-v1.3.0fork1-LE to 1.7.24
* BloodArsenal-1.3.1 to 1.4.10
* InfernalMobs-1.9.1-GTNH to 1.10.3
* Tainted-Magic-7.6.13-GTNH to 7.6.26
* StorageDrawers-2.0.3-GTNH to 2.1.7
* WitcheryExtras-1.2.3 to 1.3.6
* Railcraft-9.15.14 to 9.16.33
* holoinventory-2.4.13-fork1 to 2.5.5
* EnderStorage-1.6.4 to 1.7.7
* MrTJPCore-1.2.1 to 1.3.4
* Forbidden.Magic-0.7.0-GTNH to 0.8.3
* defaultserverlist-1.5.0 to 1.6.5
* ae2stuff-0.8.4-GTNH to 0.9.7
* ThaumicHorizons-1.6.4 to 1.7.7-pre
* AppleCore-3.3.3 to 3.3.7
* txloader-1.7.2 to 1.8.5
* StevesCarts-2.2.0 to 2.3.12
* ForgeMultipart-1.4.7 to 1.6.8
* Forestry-4.9.16 to 4.10.17
* Avaritiaddons-1.8.4-GTNH to 1.9.1
* thaumicboots-1.3.1.2 to 1.4.14
* beebetteratbees-0.4.0-GTNH to 0.4.3
* EnderIO-2.8.21 to 2.9.22
* HardcoreEnderExpansion-1.11.3-GTNH to 1.12.13
* gadomancy-1.3.5 to 1.4.7
* SGCraft-1.4.0-GTNH to 1.4.5
* gendustry-1.8.2-GTNH to 1.9.4
* OpenBlocks-1.10.2-GTNH to 1.11.7
* QmunityLib-0.2.0 0.3.1
* buildcraft-compat-7.1.17 to 7.1.18
* WirelessCraftingTerminal-1.11.7 to 1.12.7
* RandomThings-2.4.6 to 2.6.6
* betterp2p-1.3.0 to 1.3.1
* amazingtrophies-1.2.2 to 1.3.9-pre
* netherportalfix-1.3.0 to 1.4.0
* CoreTweaks-1.7.10-0.3.3.2+nomixin to 0.3.3.6
* IronChest-6.0.87 to 6.1.6
* BetterBuildersWands-0.11.0-GTNH to 0.13.3
* tcnodetracker-1.7.10-1.1.7 to 1.4.0
* bdlib-1.10.0-GTNH to 1.11.0
* AsieLib-0.6.0 to 0.7.0
* RemoteIO-2.6.2 to 2.7.6
* nutrition-0.0.12 to 0.1.3
* TiCTooltips-1.3.0 to 1.4.0
* WanionLib-1.9.0 to 1.10.0
* Mantle-0.4.2 to 0.5.1
* TMechworks-0.3.1 to 0.4.1
* NEIIntegration-1.4.0 to 1.5.0
* torohealth-1.1.0 to 1.2.0
* Opis-1.4.4-mapless to 1.4.6-mapless
* magicbees-2.8.5-GTNH to 2.9.4
* Schematica-1.11.2-GTNH to 1.12.6
* Ztones-2.3.1-GTNH to 2.3.2
* SpecialMobs-3.6.2 to 3.7.0
* ModTweaker2-0.10.0 to 0.12.0
* CraftTweaker-3.4.0 to 3.4.2
* SuperTic-1.4.0 to 1.5.0
* endercore-0.4.6 to 0.4.8
* FloodLights-1.4.2 to 1.5.4
* OpenModsLibs-0.10.8 to 0.10.10
* StevesAddons-0.13.0 to 0.14.2
* custommainmenu-1.11.0 to 1.12.1
* tinkersdefense-1.2.2 to 1.3.2
* irontanks-1.3.0 to 1.4.2
* IronChestMinecarts-1.1.0 to 1.2.0
* CookingForBlockheads-1.3.7-GTNH to 1.4.4
* OpenGlasses-1.5.0-GTNH to 1.6.1
* StevesFactoryManager-1.3.2-GTNH to 1.3.4
* bugtorch-1.2.13-GTNH to 1.2.14
* Thaumcraft4Tweaks-1.5.24 to 1.5.39
* JustEnoughCalculation-1.7.10-4.2 to 4.9
* +unimixins-all-1.7.10-0.1.19 to 0.1.23
* Universal-Singularities-8.7.0 to 8.10.0
* signpost-1.7.10-1.08.4 to 1.3.5
* antiqueatlas-1.7.10-4.4.4 to 4.4.6
* OpenModularTurrets-2.3.6 to 2.4.3
* naturescompass-1.4.4-GTNH to 1.5.0
* thaumicinsurgence-0.3.0 to 0.4.0
* opensecurity-1.1.1-GTNH to 1.2.0
* CarpentersBlocks-3.6.2-GTNH to 3.7.0
* WAILAPlugins-0.5.1 to 0.6.0
* travellersgearneo-1.2.2 to 1.2.4
* LunatriusCore-1.2.0-GTNH to 1.2.1
* endlessids-mc1.7.10-1.5.6 to 1.6.11
* falsepatternlib-mc1.7.10-1.4.6 to 1.9.0
* falsetweaks-mc1.7.10-3.4.3 to 4.0.2
* XaerosWorldMap_1.14.1.32_Forge_1.7.10 to 1.14.1.33
* Mekanism-Community-Edition-1.7.10-9.10.41-Core to 9.10.45
* Mekanism-Community-Edition-1.7.10-9.10.41-Tools to 9.10.45
* Mekanism-Community-Edition-1.7.10-9.10.41-Generators to 9.10.45
* !mod-director-launchwrapper-1.8.3 to 1.9.1
* chunkapi-mc1.7.10-0.5.2 to 0.6.4fork1
* ChickenChunks-1.7.10-1.3.4.19-universal to 1.3.4.27
* spark-1.10.19-forge1710 to 1.10.20

**mods deleted**

* angelica-1.0.0-beta23-fork1
* Colored+Iron Version 1.0 
* FloorBallCraft-Mod-1.7.10 
* MineMenu-1.7.10-1.2.0.B44-universal 
* thaumcraftneiplugin-1.7.10-1.7a 
* ProjectS~1.20{1.7.10} 
* ne-1.7.10-15.5.21-R1.0 
* ParallelWorld
* inventorytweaks-1.7.0
* Item.Frame.Remover-1.7.10-0.2
* mobs-no-render-1.7.10-05
* neodymium-mc1.7.10-0.4.0-unofficial
* evilnotchlib-a109
* confighelper-1.7.10-1.2.5.5
* DimensionGuard-1.7.10-1.2.2
* MouseTweaks-2.4.17-GTNH
* craftingtweaks-mc1.7.10-1.0.88
* creativecore-1.4.0 
* Improving Minecraft-1.12.3 for Minecraft 1.7.10
* malisiscore-0.15.0
* entityculling-1.6.4-mc1.7.10
* screwdriver-2.4.2
* kokoalinux-1.7.10-1.3.2
* SeedCopy-1.7.10-1.0.0
* [1.7.10] Tinker's Middleearth-1.3.9
* Treasure-3.0.8-mc1.7.10
* more_armor-1.7.10-1.1.2
* sourcecodedcore-1.7.10-1.0.2-UNIVERSAL
* beheaded-1.7.10-0.3.1-UNIVERSAL
* antiquemarkers-1.7.10-1.0a

**config updated**

-archaicfix.cfg
* enabled "clearMixinCache"
* disabled "enablePhosphor"

-harvestcraft.cfg 
* disabled "sheepdropMutton"

-etfuturum/blocksitems.cfg 
* disabled "enableMutton"

-TwilightForest.cfg 
* disabled "DisablePortalCreation"

-beddium.cfg
* enabled "UseMultiDrawIndirect"
* (move to brandyn config)

-falsetweaks.cfg
* set startupOptimizations to true
* (move to brandyn config)

-hodgepodge.cfg
* set limitRecursiveBlockUpdateDepth to -1 (instead of 256)
* disabled "unboxMapGen"
* disabled "fixEventBusMemoryLeak"
* disabled "speedupNBTTagCompoundCopy"

-Bibliocraft.cfg
* disabled "CheckForUpdates"

-endlessids.cfg
* enabled "extendEnchantment"
* enabled "extendEntity"
* enabled "extendPotion"

-optimizationsandtweaks.cfg
* disabled "enableMixinThreadedFileIOBase"
* disabled "enableMixinNetHandlerPlayClient" 
* disabled "enableMixinFontRenderer"

**fixe**

* fix some bugs/crashes by updating lotr mod
* fix java.io.FileNotFoundException when trying to load menu.json caused by MineMenu by removing it
* fix java.lang.NoClassDefFoundError: net.minecraft.pathfinding.PathFinder by updating optimizationsandtweaks
* fix Error while looking up crafting recipe by removing thaumcraft nei plugin
* fix an another null crash exception from AppleFuelHandler from growthcraft mod by updating optimizationsandtweaks
* fix a class cast exception from SimpleLabels by updating it 
* fix infinite loop generation while generating VillageRoad from farlanders mod by updating optimizationsandtweaks
* potentialy fix error caused by ThreadOperationTimer from NEI By updating it   
* fix Error while looking up usage recipe by removing Project Spawn
* fix [#941](https://github.com/quentin452/privates-minecraft-modpack/issues/941) 
* fix [#939](https://github.com/quentin452/privates-minecraft-modpack/issues/939) 
* fix [#936](https://github.com/quentin452/privates-minecraft-modpack/issues/936) 
* fix [#938](https://github.com/quentin452/privates-minecraft-modpack/issues/938) 
* fix [#940](https://github.com/quentin452/privates-minecraft-modpack/issues/940) 
* fix [#338](https://github.com/quentin452/privates-minecraft-modpack/issues/338) 
* fix [#942](https://github.com/quentin452/privates-minecraft-modpack/issues/942)
* fix [#935](https://github.com/quentin452/privates-minecraft-modpack/issues/935) 
* fix "Exception filtering 1xtile.hl_woodSlabDouble@3 with codechicken.nei" by removing highlands
* fix crash on startup by removing DimensionGuard-1.7.10-1.2.2 (caused by codechickencore)
* fix a BIG spam log caused by Improving Minecraft (probably due to endless ids entity id extender)
* fix crash on startup by removing malisiscore
* fix pc freeze at profiling (spark) on linux by updating it
* fix ender io requiring an newer version of CofhLib by removing screwdriver
* fix crash on startup with lwjgl3ify "java.lang.LinkageError: loader constraint violation: loader 'Launch' @77c2494c wants to load class org.lwjgl.glfw.GLFWVidMode" by removing kokoalinux
* fix crashes at init by removing seedcopy, tinkers middleearth, more_armor, sourcecodedcore and beheadeddue to lwjgl3ify
* fix a crash on startup du to non extensible enums by removing treasure

**other**

* deleted Colored Iron + Nether enhancement because many textures are invalid
* reduce loading time by updating biggesspacktweaks , IamacatHud and optimizationsandtweaks
* remove pams harvestcraft and et futurum requiem raw mutton loot when killing muttons
* finally reenabled twilight forest portal (Dimension) 
* replaced inventory tweaks by inventory bogo sorter
* disabled CheckForUpdates from bibliocraft to greatly reduce time to load
...
* archaicfix-0.7.0fork7 to 0.7.0fork9 

**fixe**

* Fix "ArrayIndexOutOfBoundsException caused by getCachedLightFor" by updating Archaicfix
...
* made leaf culling only installed client side (not needed to update if you use V0.98.6 only on client but the update is needed on server)
...
* leafculling-mc1.7.10-1.1.0

**mods updated**

* IamacatHUDV0.6 to V0.7
* optimizationsandtweaks-V1.14.2 to V1.14.4
* angelica-1.0.0-beta18 to beta23fork1
* NotEnoughItems-2.6.44-GTNH to 2.6.47
* endercore-0.3.1 to 0.4.6

**config updated**

-falsetweaks.cfg
* disable ITEM_RENDER_LISTS

**fixe**

* fix some bugs/crash caused by angelica by updating Not Enough Items ,Angelica and OptimizationsAndTweaks
* fix crashes with EnderIO By updating EnderCore
* fix crash caused by splash by disabling it

**other**

* disabled ITEM_RENDER_LISTS from falsetweaks because angelica had already this functionnality
...
-EntityCulling.cfg
* disable renderNametagsThroughWalls
-entityculling.json
* disable renderNametagsThroughWalls

**mods updated**

* optimizationsandtweaks-V1.14.1 to V1.14.3
...
* fix lotr class not found exception crash caused by corruped jar of lotr
...
* optimizationsandtweaks-V1.14.0 to V1.14.1
* Galacticraft-V4.1.7 to V4.1.8
* eotg-V1.5.5 to V1.5.6
* LOTRModfork.v36.28 to v36.29

**config updated**

-optimizationsandtweaks.cfg 
* disable enableMixinPatchSpawnerAnimals

**fixe**

* try to fix "java.lang.IllegalArgumentException: Default value cannot be lower than minimum value!" by updating optimizationsandtweaks
* fix ConcurrentModificationException from SpawnCreaturesTask by updating optimizationsandtweaks
* fix null crashes from getSkyBlendColour from ForgeHooksClient and from onRenderFog by updating optimizationsandtweaks
* fix null crashes during ticking entities in lotr dimension by updating lotr mod
* fix many issues crashes,entity spawning too much by disabling enableMixinPatchSpawnerAnimals from optimizationsandtweaks
* fix null crash caused by galacticraft when joining lotr dimension by updating galacticraft
* fix "java.lang.NoClassDefFoundError: cpw/mods/fml/client/FMLClientHandler" by updating essence of the god
...
* immibis-core-59.1.4
* autofood-59.0.0
* KitchenCraft-MC1.7.10-1.0.0-63-combo

**config updated**

-optimizationsandtweaks.cfg
* disable enableMixinCompressedStreamTools

**fixe**

* fix "There was a critical exception handling a packet on channel FML" by removing immibis
* fix "An unknown error was thrown loading class org.wyldmods.kitchencraft.foods.common.compat.EnderIOCompat" by removing KitchenCraft
* fix when enterring in the nether ,the nether not loading by removing KitchenCraft
* fix GZIPInputStream2 crash by updating optimizationsandtweaks config 
...
* angelica-1.0.0-alpha20fork1 to angelica-1.0.0-beta18
* !mod-director-launchwrapper-1.8.0-all to 1.8.3
* +unimixins-all-1.7.10-0.1.15 to 0.1.19
* AdvancedBackups-forge-1.7.10-3.4 to 3.6.4
* zume-0.10.0 to 1.1.4
* wisla-1.0.0 to 1.2.0
* ssmlegacy-mc1.7.10-1.2.1 to 1.2.3
* serializationisbad-1.5 to 1.5.2
* hamsterrific-0.2.1 to 0.2.2
* gtnhlib-0.2.1 to 0.5.20
* falsetweaks-mc1.7.10-2.8.1 to 3.4.3
* chunkapi-mc1.7.10-0.5.0 to 0.5.2
* [1.7.10] Tinker's Middleearth-1.3.8 to 1.3.9
* [1.7.10] The Rings of Power v23.10.29 to 24.07.19
* XaerosWorldMap_1.14.1.30_Forge_1.7.10 to 1.14.1.32_Forge_1.7.10
* Titanpower-1.7.10-1.6.7 to 1.6.8
* extrautilities-1.2.12 to 1.2.12.2
* Thaumcraft4Tweaks-1.5.20 to 1.5.24
* MoCreatures-Legacy-Beta-1.2 to Final-1.1
* Mekanism-Community-Edition-1.7.10-9.10.35-Core to 9.10.41
* Mekanism-Community-Edition-1.7.10-9.10.35-Generators to 9.10.41
* Mekanism-Community-Edition-1.7.10-9.10.35-Tools to 9.10.41
* Electroblob.s.Wizardry.-.1.1.6.-.MC.1.7.10fork5 to wizardry-1.7.10-1.1.6fork6
* CodeChickenCore-1.2.1 to 1.3.10
* DefaultSettings-1.7.10+1.12.2-4.0.5-Forge to 1.12.2-4.0.7-Forge
* appliedenergistics2-rv3-beta-312-GTNH-FORK1 to rv3-beta-474-GTNH
* EnderIO-2.6.4 to 2.8.21
* nutrition-0.0.7-pre to 0.0.12
* NotEnoughItems-2.4.13-GTNHfork3 to 2.6.44-GTNH
* FloodLights-1.3.0 to 1.4.2
* hodgepodge-2.4.20fork1 to 2.5.77.fork1
* JustEnoughCalculation-1.7.10-4.0 to 4.2
* TwilightForest-2.5.4-pre to TwilightForest-2.6.35
* TConstruct-1.11.10-GTNH-pre to 1.12.13
* ThaumicHorizons-1.5.1 to 1.6.4
* adventurebackpack-1.1.1-GTNH to 1.2.3
* ae2stuff-0.7.0-GTNH to 0.8.4
* amazingtrophies-1.1.5 to 1.2.2
* AppleCore-3.2.12fork1 to 3.3.3
...
* falsepatternlib-mc1.7.10-1.0.0fork1 to 1.4.6
...
* netherportalfix-1.7.10-1.1.2 to 1.2.0 
...
* fix large tps lags by updating archaicfix
* fix crash by updating optimizationsandtweaks
...
* vastly improved tps performance caused by the lightning engine by updating archaicfix
...
* zeldaswordskills-1.7.10-v2.5.3.3 to v2.5.3.4 
...
* primitive-mobs-rozmirs-fork-1.0 
* Super Ores V1.3 mc-1.7.10 
