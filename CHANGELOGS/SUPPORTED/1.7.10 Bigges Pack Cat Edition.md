...
java8 GRAALVM : Ram used ~5 gb and 4min to start the client and Ram used ~4 gb and 4min to start the server on my system.
...
⚠️ If you want matmos to be work , download the ressourcepack mat zen⚠️
⚠️ If you update from an really older version from the modpack its recommanded removing all mods from your mods folder(but not mod director) ⚠️
