...
1 : 
-Xms=128m -Xmx=7000m (These recommanded args use less ram usage than the second but made more stutters than the second)
...
2 : 
-Xms=128m -Xmx=7000m (These recommanded args use more ram than the first but made really less stutters than the first)
...
java8 Adoptium Openjdk : Ram used ~7 gb and 4min to start the client and Ram used ~6 gb and 4min to start the server on my system.
...
⚠️ Remove all mods and config files before updating, except !mod-director-launchwrapper-1.8.0-all.jar and sampler-1.60.1.jar ⚠️
⚠️ Remove all mods and config files before updating, except !mod-director-launchwrapper-1.8.0-all.jar and sampler-1.60.1.jar ⚠️
...
* should reduce ram usage by alot caused by LaunchClassLoader by updating OptimizationsAndTweaks
