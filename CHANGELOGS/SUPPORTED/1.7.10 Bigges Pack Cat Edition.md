...
* LOTR Extended v23.10.29 ?????????????????????
* LOTR Improvements-1.0.9 ?????????????????????
* LOTRMod v36.16 ?????????????????????
* LOTR-UCP-1.3.0 ?????????????????????
* ZZZ_LOTRFixer ?????????????????????
* eotg-V1.3 to V1.4 ?????????????????????
...
* endlessids-mc1.7.10-1.5-alpha0010 to 1.5-beta0001 ?????????????????????
...
-TwilightForest.cfg
* fix conflicted ids caused by TwilightForest ?????????????????????
...
* removed Better Boat because need Bookshelf ?????????????????????

**fixe**

* fix [#519](https://github.com/quentin452/privates-minecraft-modpack/issues/519) ?????????????????????
* fix [#502](https://github.com/quentin452/privates-minecraft-modpack/issues/502) ?????????????????????
* fix crash on startup with LOTR by switching again between frustrator and Opticubes ?????????????????????
