...
1 : 
-Xms128m -Xmx7000m (These recommanded args use less ram usage than the second but made more stutters than the second)
...
2 : 
-Xms128m -Xmx7000m (These recommanded args use more ram than the first but made really less stutters than the first)
...
* fix large lag caused by Goron model from zelda sword skills by updating zelda sword skills and updating zelda configs 
