...
⚠️ You should remove all of your mods in your mods folder (but not !mod-director-launchwrapper-1.8.0-all) because you can get errors/crash on startup when you update the modpack⚠️
...
**If you update the modpack only from one older version or since V0.85.8.5 it should be ok to leave your mods folder without removing mods**
...
* multithreadingandtweaks-V0.8.8.9 to V0.8.9.6 
...
* make has not planned/wontfix [#458](https://github.com/quentin452/privates-minecraft-modpack/issues/458)
