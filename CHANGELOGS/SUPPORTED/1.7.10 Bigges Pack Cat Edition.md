...
java8 GRAALVM : Ram used ~9 gb and 4min to start the client and Ram used ~6 gb and 4min to start the server on my system.
...
* fix some SaltyMod Expanded cascadings worldgens by updating it 
* fix a potential crash on startup by updating Salty Expanded 
