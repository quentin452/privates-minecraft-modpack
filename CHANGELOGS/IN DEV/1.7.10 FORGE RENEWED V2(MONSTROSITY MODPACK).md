* ✔️ fix fps stuttering
* ✔️ fix extreme fps stuttering
* ✔️ fix tps lag
* ✔️ reduce structure spawning
* ❌ reduce world loading time(priority 1)(working on it)
* ✔️ reduce world saving time
* ✔️ fix item take long time to falls
...
* notenoughids make tps lag when you start the world
...
* fix world take long time to load caused by minions
