* ❌ fix fps stuttering(working on it)(priority 1)
* ❌ fix tps lag(working on it)(priority 2)
* ✔️ reduce structure spawning
* ❌ reduce world loading time(working on it)(priority 3)
* ✔️ fix item take long time to falls(working on it)(priority 4)
...
* fix tps lag caused by
* fix item take long time to falls caused by cuchaz.ships
* fix world take long time to load caused by 
