* ❌ fix Failed to load sub-texture(working on it)(priority 0)
* ❌ fix fps stuttering(working on it)(priority 1)
* ❌ fix tps lag(working on it)(priority 2)
* ❌ reduce structure spawning(working on it)(priority 3)
* ❌ reduce world loading time(working on it)(priority 4)
