...
* ❌ fix Recipe has too many inputs
* ✔️ reduce ram usage
* ❌ fix crash(renderlib) and battle tower have lightning bugs seed : -6237343044658597744,49395396020153756
* ✔️ reduce world loading time
* ❌ fix Exception caught during firing event
* ❌ fix foamfix cascading worldgen lag **(priority high)**
* ❌ fix java.util.concurrent.ExecutionException: java.lang.ArrayIndexOutOfBoundsException: Array index out of range: 6 crash when make a world
