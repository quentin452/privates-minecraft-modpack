...
* ❌ configure dimensions/biome ID in configs

**BETA(working on it)**

* ❌ fix fatals errors
* ❌ optimize tps usage
* ❌ fix fps extreme stuttering ~2-5 fps (working on it)
* ✔️ reduce ram usage
...
* ❌ fix foamfix cascading worldgen
...
* fix fps stuttering caused by LiminalInfiniteless , ChocoboKnightsOfTheCraftingTableByBladeAndFeather , DynamicSurroundings , thaumcraft
